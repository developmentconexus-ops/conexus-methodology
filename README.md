...
5. Fable materializes its review as NON-AUTHORITATIVE review input in the working repository when the review is part of the repo workflow, then reports completion in chat.
